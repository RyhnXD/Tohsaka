...
global.owner = [
  ...
  ['+62 817 7921 1748'],
  ['+62 177 9211 748'],
  ['+62 895-6275-14070', 'ʜᴀɴ', false],
  ['62895627514070', 'ʜᴀɴ', false],
  ['+62 817 7921 1748', 'Bot', true],
  ['+62 895 6275 14070', 'ʜᴀɴ', true],
  ['+62 895-6275-14070', 'ʜᴀɴ', false],
...
global.wm = '                「 雨 sᴀᴋᴜʀᴀ サンダー 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘ʜᴀɴ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '❀ sᴀᴋᴜʀᴀ'
global.botdate = `☢︎︎ ᴅᴀᴛᴇ :  ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}`

global.bottime = `𝗧 𝗜 𝗠 𝗘 : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}`
global.titlebot = `☢︎︎ ᴛɪᴍᴇ sᴇʀᴠᴇʀ : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}\n⫹⫺ Date Server :  ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}
`
global.author = 'sᴀᴋᴜʀᴀ ʜᴇɴᴛᴀɪ'
